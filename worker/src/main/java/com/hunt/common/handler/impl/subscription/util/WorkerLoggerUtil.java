 ...
 */
package com.hunt.common.handler.impl.subscription.util;
...
public class WorkerLoggerUtil extends LoggerUtil {
  ...
  public void workerBeansFound(Class<WorkerFunction> workerFunctionClass,
                               Map<String, WorkerFunction> beanNamesForType) {
